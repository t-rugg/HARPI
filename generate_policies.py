...
adm = {
    ...
    "federalist_ideas": ("state_maintenance_modifier = -0.25", "diplomatic_reputation = 1", "discipline = 0.035", "state_maintenance_modifier = -0.25", "reduced_liberty_desire_on_same_continent = 10", "leader_land_manuever = 1"),
    "governance_ideas": ("global_tax_modifier = 0.15", "global_own_trade_power = 0.1", "reserves_organisation = 0.1", "vassal_income = 0.25", "diplomatic_upkeep = 1", "reinforce_speed = 0.15"),

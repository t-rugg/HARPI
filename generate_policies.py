...
mil = {
	...
	"plutocracy_ideas": ("build_time = -0.075", "naval_morale_damage_received = 0.1", "mercenary_manpower = 0.2", "yearly_corruption = -0.075", "global_prov_trade_power_modifier = 0.1", "drill_decay_modifier = -0.2")
}

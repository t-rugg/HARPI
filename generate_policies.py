...
adm = { # legalist ideas get special handling
	...
	"expansion_ideas": ("build_cost = -0.075", "colonist_placement_chance = 0.035" , "global_manpower_modifier = 0.10", "religious_unity = 0.075", "trade_steering = 0.25", "merc_leader_army_tradition = 0.15"),
	"administrative_ideas": ("overextension_impact_modifier = -0.05", "adm_advisor_cost = -0.15", "yearly_army_professionalism = 0.002", "global_autonomy = -0.05", "yearly_corruption = -0.05", "mercenary_discipline = 0.035"),
...
dip = {
	...
	"court_ideas": ("advisor_cost = -0.075", "yearly_corruption = -0.05", "army_tradition_decay = -0.01", "stability_cost_modifier = -0.1", "spy_offence = 0.25", "vassal_forcelimit_bonus = 0.25"),
	...
	"stewardship_ideas": ("interest = -0.5", "vassal_income = 0.25", "vassal_forcelimit_bonus = 0.25", "yearly_corruption = -0.05", "trade_steering = 0.25", "fire_damage_received = -0.05"),
	...
	"adventure_ideas": ("years_of_nationalism = -3", "improve_relation_modifier = 0.1", "global_manpower_modifier = 0.10", "available_province_loot = 0.25", "prestige_from_land = 0.5", "shock_damage = 0.05"),
...
mil = {
	...
	"naval_ideas": ("global_prosperity_growth = 0.2", "trade_efficiency = 0.075", "merc_leader_army_tradition = 0.15", "prestige_from_naval = 0.5", "global_sailors_modifier = 0.15", "leader_land_manuever = 1"),
...
legalist_adm = {
	...
	"humanist_ideas": "religious_unity = 0.15",
	...
	"federalist_ideas": "num_accepted_cultures = 2",
...
legalist_mil = { # these aren't THAT much better than other mil policies; otherwise you'd have to take legalist every MP game
	...
	"mercenary_ideas": "merc_leader_army_tradition = 0.33",
	...
	"expeditionary_ideas": "colonist_placement_chance = 0.075", # special! not a military modifier per se
	"subterranean_ideas": "land_maintenance_modifier = -0.15",
	"plutocracy_ideas": "mercenary_discipline = 0.075"
	# TODO
}
